<?php	
	...
	$sql = "SELECT * FROM temporal_mdoct;";
...
'aaaaaceeeeiiiinooooouuuuyyAAAAACEEEEIIIINOOOOOUUUUY');	
		...
		$sql_alumno_programa = "SELECT COUNT(*) AS registros FROM alumnos_programas WHERE cuenta = '".$fila["cuenta"]."' AND id_alumno = '".$id_alumno."' AND id_plan_estudio = '6';";
		...
		{		
			$sql_programa = "INSERT INTO alumnos_programas (id_alumno, id_plan_estudio, cuenta, clave, estatus) VALUES ('".$id_alumno."', '6', '".$fila["cuenta"]."', '".$fila["cuenta"]."', '".$estatus."');";		
			...
			if(!mysqli_error($conexion))
			{
				...
				$sql_materias = "SELECT id_materia, semestre, clave_materia FROM materias WHERE id_plan_estudio = '6' ORDER BY semestre, clave_materia ASC;";			
