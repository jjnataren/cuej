...
$this->fontdata = array(
    ...
    "coper" => array(
        'R' => "copperplategothiclight.ttf",
        'B' => "copperplategothiclight.ttf",
        'I' => "copperplategothiclight-Oblique.ttf",
        'BI' => "copperplategothiclight-BoldOblique.ttf",
    ...
    "timesnewrom" => array(
        'R' => "timesnewrom.ttf",
        'B' => "timesnewrom.ttf",
        'I' => "timesnewrom-Oblique.ttf",
        'BI' => "timesnewrom-BoldOblique.ttf",

    ),

    "edwardian" => array(
        'R' => "edwardian.ttf",
        'B' => "edwardian-Bold.ttf",
        'I' => "edwardian-Oblique.ttf",
        'BI' => "edwardian-BoldOblique.ttf",
