...
?>
	...
	<form name="Formulario" id="Formulario" action="../impresiones/Servicios_Escolares/Datos_Generales_XLS.php" method="POST" target="_blank" >
            ...
            <center><input type="submit" value="Descargar Datos Generales XLS" class="button"/></center>
        </form>
     </p>
<?php
	}
