...
*/
	...
	{	
		$sql = "INSERT INTO horarios (id_grupo, id_materia, id_profesor, hora_inicio_1, hora_fin_1, hora_inicio_2, hora_fin_2, hora_inicio_3, hora_fin_3, hora_inicio_4, hora_fin_4, hora_inicio_5, hora_fin_5, hora_inicio_6, hora_fin_6) VALUES ('".$_POST["id_Grupo"]."','".$_POST["id_Materia"]."','".$_POST["id_Profesor"]."','".$_POST["Hora_Inicio_1"]."','".$_POST["Hora_Fin_1"]."','".$_POST["Hora_Inicio_2"]."','".$_POST["Hora_Fin_2"]."','".$_POST["Hora_Inicio_3"]."','".$_POST["Hora_Fin_3"]."','".$_POST["Hora_Inicio_4"]."','".$_POST["Hora_Fin_4"]."','".$_POST["Hora_Inicio_5"]."','".$_POST["Hora_Fin_5"]."','".$_POST["Hora_Inicio_6"]."','".$_POST["Hora_Fin_6"]."')";
