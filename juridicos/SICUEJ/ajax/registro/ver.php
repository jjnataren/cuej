...
<form id="frmRegistro">
	<table  class="cuej">
		<thead>
			<tr>
				<th class="cuej" colspan="4">Actualizar registro de actividad</th>
			...
			<tr>
				...
				<td class="cuej" colspan="2">
					<div class="form-group">
                                ...
                                <input value="<?php echo $persona;?>" class="form-control" id="persona" name="persona" aria-describedby="personaHelp" placeholder="Ingrese valor">
			...
			<tr>
				<td class="cuej">
					<div class="form-group">
                        ...
                        <input value="<?php echo $avance;?>" class="form-control" name="avance" id="avance" aria-describedby="avanceHelp" placeholder="Clic para ingresar valor">
				...
				<td class="cuej">
					<div class="form-group">
                        ...
                        <input value="<?php echo $final;?>" class="form-control" name="final" id="final" aria-describedby="finalHelp" placeholder="Clic pata ingresar valor">
			...
			<tr>
				...
				<td class="cuej" colspan="4">
					<div class="form-group">
                        ...
                        <textarea  class="form-control" name="descripcion" id="descripcion" aria-describedby="comentariosHelp" placeholder="Ingrese valor" > <?php echo $descripcion;?> </textarea>
	...
	<p align="center">
		<input class="button" type="button" id = "btnActualizar" name = "btnInsertar"  value = "Actualizar" />
