...
/*
	...
	-- País: México
	-- Objetivo: Captura de Calificaciones por Materia
...
<script language="javascript">
	...
	$('Body').ready(function(){
		$('#id_Carrera').change(function(){
			Calificaciones_Planes_Estudio_Buscar($(this).val())
		});
		
		$('#id_Plan_Estudio').change(function(){
		    Calificaciones_Semestres_Buscar($(this).val())
	     });
		
		$('#Semestre').change(function(){
		    Calificaciones_Grupos_Buscar($('#id_Plan_Estudio').val(), $('#id_Ciclo_Escolar').val(), $(this).val());
	     });
		
		$('#id_Materia').change(function(){
		    Calificaciones_Profesor_Buscar($('#id_Grupo').val(), $(this).val());
	     });
...
<table  width="100%" align="center">
	<thead>
		<tr>
			<th  colspan="4"> CALIFICACIONES<div class="header_01"><hr /></div></th>
		</tr>
	</thead>
</table>
<p>&nbsp;</p>
<form id="Frm_Calificaciones">
	<table width="100%" align="center">
		<tr>
			<td>
...
?>
		...
		<tr>
          ...
          <tr>
			...
			<td>
				<input type="text" class="campo" name="Profesor" id="Profesor" value="" size="50" readonly />
			</td>
		</tr>
          <tr>
