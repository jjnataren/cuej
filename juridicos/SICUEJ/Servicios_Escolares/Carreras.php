...
<script language="javascript">
	...
	$('Body').ready(function(){
		...
		$('#Btn_Nueva_Carrera').click(function(){
			Carreras_Nueva();
		});
...
<table  width="100%"  align="center">
	<thead>
		<tr>
			<th  colspan="4">ADMINISTRACIÓN DE CARRERAS<div class="header_01"><hr /></div></th>
		</tr>
	</thead>
</table>
<p> &nbsp; </p>
	...
	<table width="100%" align="center">
		<tr>
			<td>
				...
				<input class="campo" type = "text" name = "Carrera" id = "Carrera" value = "" size="35"/>
...
<?php 
	...
	{
?>
				<input class="button" type="button" id = "Btn_Nueva_Carrera" name = "Btn_Nueva_Carrera"  value = "Nueva Carrera" />
<?php
	}
?>
			</td>
