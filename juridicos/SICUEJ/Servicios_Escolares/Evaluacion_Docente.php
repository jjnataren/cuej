...
<script language="javascript">
	...
	$('Body').ready(function(){
		$('#id_Carrera').change(function(){
			Evaluacion_Docente_Planes_Estudio_Buscar($(this).val())
		});
		
		$('#id_Plan_Estudio').change(function(){
		    Evaluacion_Docente_Semestres_Buscar($(this).val())
	     });
		
		$('#Semestre').change(function(){
		    Evaluacion_Docente_Grupos_Buscar($('#id_Plan_Estudio').val(), $('#id_Ciclo_Escolar').val(), $(this).val());
	     });
...
<table  width="100%" align="center">
	<thead>
		<tr>
			<th  colspan="4"> EVALUACI&Oacute;N DOCENTE <div class="header_01"><hr /></div></th>
		</tr>
	</thead>
</table>
<p>&nbsp;</p>
<form id="Frm_Evaluacion_Docente">
	<table width="100%" align="center">
		<tr>
			<td>
