...
<div id="wrapper">
	<div id="header">
		<div id="logo">
			<img src="/SICUEJ/imagenes/logo_cuej.png" alt="CUEJ" width="200px" />
		</div>
        <div id="user">
        	<table border="0" width="100%">
            	<tr>
                	<td><img src="/SICUEJ/imagenes/usuario.png" alt="SIUP" width="120px"/></td>
					<td><?php echo htmlentities($_SESSION["Titulo"].' '.$_SESSION["Nombre"].' '.$_SESSION["Apellido_Paterno"].' '.$_SESSION["Apellido_Materno"]); ?><br /><a href="/SICUEJ/php/Salir.php">Salir</a></td>
...
?>
									<li>
                                             	<a href="/SICUEJ/<?php echo $fila_procesos["carpeta"];?>/<?php echo $fila_procesos["proceso_archivo"] ?>"><?php echo $fila_procesos["proceso_nombre"] ?></a>
                                             </li>
<?php
			}
		}
...
?>
											<li>
                                                       	<a href="/SICUEJ/<?php echo $fila_procesos_menu["carpeta"];?>/<?php echo $fila_procesos_menu["proceso_archivo"] ?>"><?php echo utf8_encode($fila_procesos_menu["proceso_nombre"]); ?></a>
                                                       </li>
<?php
					}
...
?>
 ...
 <?php
					...
					{
?>
						<li><a href="/SICUEJ/<?php echo $fila_procesos_submenu["carpeta"];?>/<?php echo $fila_procesos_submenu["proceso_archivo"] ?>"><?php echo $fila_procesos_submenu["proceso_nombre"] ?></a></li>
<?php
					}
 ?>
                        								</ul>
