...
/*
	...
	-- País: México
	-- Objetivo: Consulta de Horario de clase
...
$sql_programa = "SELECT id_carrera_tipo, carrera, plan_estudios, id_ciclo_escolar, semestre, grupo FROM grupos JOIN planes_estudio USING(id_plan_estudio) JOIN carreras USING (id_carrera) WHERE id_grupo = '".$_SESSION["id_Grupo"]."';";
...
$sql = "SELECT * FROM horarios JOIN profesores USING (id_profesor) WHERE id_grupo = '".$_SESSION["id_Grupo"]."';";	
