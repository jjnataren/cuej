...
$html_generales = '
	...
	<table align="left" width="100%" class="cuej">
	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td class="cuej"><span class="dato">'.number_format($fila_promedio["promedio"],2).'</span></td>
		</tr>
	  </tbody>
	  <tfoot>
	  <tr>
	...
	{	
		...
		while($fila_historial = mysqli_fetch_array($resultado_historial))
		{
			...
			$html_generales .= '
		   <tr bgcolor="'.$fondo.'">
			 <td class="cuej" align="center">'.$fila_historial["semestre"].'</td>
			 <td class="cuej" align="center">'.$fila_historial["clave_materia"].'</td>
			 <td class="cuej">'.utf8_encode($fila_historial["materia"]).'</td>
			 <td class="cuej" align="center">'.$fila_historial["calificacion"].'</td>
			 <td class="cuej" align="center">'.$tipo.'</td>
			 <td class="cuej" align="center">'.$fila_ciclo_escolar["ciclo_escolar"].'</td>
			 <td class="cuej" align="center">'.$equivalencia.'</td>
           </tr>';			
		}			
	}
