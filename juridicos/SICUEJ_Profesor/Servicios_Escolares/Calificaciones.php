...
?>
		<tr>
			...
			<td class="cuej" align="center"><input type="button" value="Calificar" class="button" onclick="Calificaciones_Buscar(<?php echo $fila["id_grupo"];?>,<?php echo $fila["id_materia"]; ?>)"/></td>
		</tr>
<?php			
		}
?>
